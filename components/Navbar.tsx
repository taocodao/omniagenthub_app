...
const Navbar: React.FC<NavbarProps> = ({ isMarketingPage = false }) => {
    ...
    const { openChat } = isMarketingPage ? marketingChatContext : regularChatContext;

    // Get payment mode controls from useSmartFetch
    const { paymentMode, setPaymentMode } = useSmartFetch();
    ...
    const handleTransferSubmit = async () => {
        ...
        switch (selectedPerk) {
            ...
            case 'freeUploads':
                ...
                break;
            case 'freeWebScrape':
                currentBalance = freeWebScrapeLeft ?? 0;
                break;
            default:
                break;
        }
            ...
            if (response.ok) {
                ...
                switch (selectedPerk) {
                    ...
                    case 'freeUploads':
                        ...
                        break;
                    case 'freeWebScrape':
                        setFreeWebScrapeLeft((freeWebScrapeLeft ?? 0) - transferAmount);
                        break;
                    default:
                        break;
                }
        ...
        >
                ...
                >
                    ...
                    {freeChatsLeft !== null && (
                        <div style={{ display: "flex", alignItems: "center" }}>
                            ...
                            {freeChatsLeft !== null && freeChatsLeft >= 0 ? (
                                <>
                                    <span style={{ display: "flex", alignItems: "center", gap: "8px", marginRight: '10px' }}>
                                        <span style={{ color: "#00ff88" }}>WEBAI: {freeChatsLeft}</span>
                                        <span style={{ color: "#888" }}>|</span>
                                        <span style={{ color: "#4da6ff" }}>USDC: ${webaiBalance || '0.00'}</span>
                                    </span>
                                    {/* Base Scan Link */}
                                    <button
                                    ...
                                    <select
                                        value={paymentMode}
                                        onChange={(e) => setPaymentMode(e.target.value as 'webai' | 'usdc' | 'both')}
                                        style={{
                                            marginLeft: '15px',
                                            padding: '5px 10px',
                                            borderRadius: '5px',
                                        ...
                                        title="Choose which currency to use first"
                                    >
                                        <option value="webai">Use WEBAI First</option>
                                        <option value="usdc">Use USDC First</option>
                                        <option value="both">Auto (WEBAI → USDC)</option>
                                    </select>
                                </>
                            ) : (
                                tokenBalance && (
            ...
            <div>
                ...
                <Link
                    ...
                    style={{
                        marginRight: "1rem",
                        color: currentPath === "/ChatHome" ? "white" : "#0096FF",
                ...
                <Link
                    ...
                    style={{
                        marginRight: "1rem",
                        color: currentPath === "/shop" ? "white" : "#0096FF",
                        pointerEvents: currentPath === "/shop" ? "none" : "auto",
                        cursor: currentPath === "/shop" ? "default" : "pointer",
                        transition: "transform 0.2s ease",
                        display: "inline-block",
                    }}
                    className={`${styles.navLink}`}
                ...
                <div className={styles.socialIcons}>
                    ...
                    <a
                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(
                            redditMessage
                        )}&url=${encodeURIComponent("https://omniagenthub.com")}`}
                        target="_blank"
            ...
            >
                ...
                <div className={styles.transferForm}>
                    ...
                    <label>
                        ...
                        <select
                            value={selectedPerk}
                            onChange={(e) => setSelectedPerk(e.target.value as 'freeTrades' | 'freeUploads' | 'freeWebScrape' | '')}
                        ...
                        >
                            ...
                            <option value="freeWebScrape">Free WebScrapes: {freeWebScrapeLeft !== null ? freeWebScrapeLeft : 'N/A'}</option>
                        </select>
                    </label>
