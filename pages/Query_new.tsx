...
export default function QueryPage() {
    ...
    // Fixed the return statement by adding a parent fragment
    return (
        <>
            {!address ? (
                <SignIn />
