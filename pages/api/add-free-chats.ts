...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const { userKey, hashedUserId, freeTrades, freeUploads, freeWebScrape, promoCodeUsed } = req.body as AddFreeChatsRequest;
    ...
    try {
        ...
        if (hashedUserId)
            ...
            //hashedUserKey = HashUtil.hashTo(userKey);
        ...
        // Use safe increment function for all operations
        const updatedBalances = {
            freeTrades: await safeIncrement(freeTradesKey, freeTrades),
