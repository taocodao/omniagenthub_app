...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        console.log(`[get-selected-sources] Retrieved sources for ${userAddress}:`, selectedSources);

        return res.status(200).json({ selectedSources });
    } catch (error) {
